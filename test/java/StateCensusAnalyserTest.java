...
public class StateCensusAnalyserTest {
    private static final String CORRECT_CSV_FILE_PATH = "Book1.csv";
    private static final String WRONG_CSV_FILE_PATH = "Book1.csv";
    private static final String INCORRECT_FILE_FORMAT = "IncorrectFileFormat.txt";
    private static final String CSV_WITH_WRONG_DELIMITER = "CensusDataWithWrongDelimiter.csv";
    private static final String CSV_WITH_INCORRECT_HEADER = "CensusDataIncorrectHeader.csv";
    @Test
